...
ggsave(filename = 'shannon_index_plot.tif', plot = shannon_index_plot, device = 'tiff', dpi = 300, width = 7, height = 3)
...
ggsave(filename = 'taxon_abundance_plot.tif', plot = taxon_abundance_plot, device = 'tiff', dpi = 300, width = 7, height = 7)
...
ggsave(filename = 'Ig_joined_plots.tif', plot = Ig_joined_plots, device = 'tiff', dpi = 300, width = 7, height = 7)
...
ggsave(filename = 'subject_estimates_plot.tif', plot = subject_estimates_plot, device = 'tiff', dpi = 300, width = 8, height = 8)


# Prepare the plot data for export. These allow the visualized estimates and intervals to be expressed as tables.

IgG_ratio_stats <- ggplot_build(IgG_ratio_plot)
IgG_ratio_stats_50 <- IgG_ratio_stats$data[[1]]
IgG_ratio_stats_50 <- IgG_ratio_stats_50[,c(7,8,10,11,12)]
colnames(IgG_ratio_stats_50)[4:5] <- c('Q25','Q75')
IgG_ratio_stats_95 <- IgG_ratio_stats$data[[2]]
IgG_ratio_stats_all <- cbind(IgG_ratio_stats_50,IgG_ratio_stats_95[,11:12])
colnames(IgG_ratio_stats_all)[6:7] <- c('Q2.5','Q97.5')
IgG_ratio_stats_all$Taxon <- IgG_ratio_stats$layout$layout$Taxon[IgG_ratio_stats_50$PANEL]
IgG_ratio_stats_all$Disease <- IgG_ratio_stats$layout$panel_scales_y[[1]]$range$range[ceiling(IgG_ratio_stats_50$group/2)]
IgG_ratio_stats_all$Stage <- 'Before'
IgG_ratio_stats_all$Stage[IgG_ratio_stats_50$group == 2] <- 'After'
IgG_ratio_stats_all$Stage[IgG_ratio_stats_50$group == 4] <- 'After'
IgG_ratio_stats_all$Stage[IgG_ratio_stats_50$group == 6] <- 'After'
IgG_ratio_stats_all$Stage[IgG_ratio_stats_50$group == 8] <- 'After'
IgG_ratio_stats_all[,3:7] <- 10^(IgG_ratio_stats_all[,3:7])
IgG_ratio_stats_all <- IgG_ratio_stats_all[,3:10]
colnames(IgG_ratio_stats_all)[1] <- 'Q50'

IgA_ratio_stats <- ggplot_build(IgA_ratio_plot)
IgA_ratio_stats_50 <- IgA_ratio_stats$data[[1]]
IgA_ratio_stats_50 <- IgA_ratio_stats_50[,c(7,8,10,11,12)]
colnames(IgA_ratio_stats_50)[4:5] <- c('Q25','Q75')
IgA_ratio_stats_95 <- IgA_ratio_stats$data[[2]]
IgA_ratio_stats_all <- cbind(IgA_ratio_stats_50,IgA_ratio_stats_95[,11:12])
colnames(IgA_ratio_stats_all)[6:7] <- c('Q2.5','Q97.5')
IgA_ratio_stats_all$Taxon <- IgA_ratio_stats$layout$layout$Taxon[IgA_ratio_stats_50$PANEL]
IgA_ratio_stats_all$Disease <- IgA_ratio_stats$layout$panel_scales_y[[1]]$range$range[ceiling(IgA_ratio_stats_50$group/2)]
IgA_ratio_stats_all$Stage <- 'Before'
IgA_ratio_stats_all$Stage[IgA_ratio_stats_50$group == 2] <- 'After'
IgA_ratio_stats_all$Stage[IgA_ratio_stats_50$group == 4] <- 'After'
IgA_ratio_stats_all$Stage[IgA_ratio_stats_50$group == 6] <- 'After'
IgA_ratio_stats_all$Stage[IgA_ratio_stats_50$group == 8] <- 'After'
IgA_ratio_stats_all[,3:7] <- 10^(IgA_ratio_stats_all[,3:7])
IgA_ratio_stats_all <- IgA_ratio_stats_all[,3:10]
colnames(IgA_ratio_stats_all)[1] <- 'Q50'

write.csv(IgG_ratio_stats_all, file = 'IgG_ratio_estimates.csv', row.names = FALSE)
write.csv(IgA_ratio_stats_all, file = 'IgA_ratio_estimates.csv', row.names = FALSE)

write.csv(new_pred_presort, file = 'presort_abundance_estimates.csv', row.names = FALSE)

write.csv(Shannon_post_means, file = 'shannon_estimates.csv', row.names = FALSE)
